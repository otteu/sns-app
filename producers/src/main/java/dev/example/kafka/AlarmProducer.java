...
public class AlarmProducer {
    ...
    public static final Logger logger = LoggerFactory.getLogger(AlarmProducer.class.getName());
...
//        props.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.0.36:9092");
        ...
        ProducerRecord<String, String> producerRecord = new ProducerRecord<>(topicName, alarm);
